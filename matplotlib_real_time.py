...
def makeFig(): #Create a function that makes our desired plot
    ...
    plt.ylim(40,100)                           #Set limits of second y axis- adjust to readings you are getting
...
while True: # While loop that loops forever
    temp = random.randint(20,40)            #Convert first element to floating number and put in temp
    P =    random.randint(50,100)          #Convert second element to floating number and put in P
